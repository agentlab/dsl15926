...
import ru.agentlab.dsl15926.diagram.edit.policies.TemplateItemSemanticEditPolicy;
...
public class TemplateEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TemplateLabelEditPart) {
			((TemplateLabelEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureTemplateLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ru.agentlab.dsl15926.diagram.edit.parts.TemplateEditPart) {
			types.add(Dsl15926ElementTypes.TemplateRole_4002);
		}
		return types;
	}
	 ...
	 * @generated
	 */
	public class TemplateFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureTemplateLabelFigure;
		...
		private void createContents() {
			...
			fFigureTemplateLabelFigure = new WrappingLabel();

			fFigureTemplateLabelFigure.setText("<...>");

			this.add(fFigureTemplateLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTemplateLabelFigure() {
			return fFigureTemplateLabelFigure;
		}
