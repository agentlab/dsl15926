 ...
 * @generated
 */
public class TemplateInstanceItemSemanticEditPolicy extends
		Dsl15926BaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public TemplateInstanceItemSemanticEditPolicy() {
		super(Dsl15926ElementTypes.TemplateInstance_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (Dsl15926VisualIDRegistry.getVisualID(outgoingLink) == TemplateRoleInstanceEditPart.VISUAL_ID) {
