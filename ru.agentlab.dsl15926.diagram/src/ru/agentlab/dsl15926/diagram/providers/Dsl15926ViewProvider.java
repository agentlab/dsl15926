 ...
 * @generated
 */
public class Dsl15926ViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = Dsl15926VisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = Dsl15926VisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!Dsl15926ElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != Dsl15926VisualIDRegistry
				...
				if (!RepositoryEditPart.MODEL_ID
						.equals(Dsl15926VisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return TemplateInstanceEditPart.VISUAL_ID == visualID
				|| ClassEditPart.VISUAL_ID == visualID
				|| TemplateEditPart.VISUAL_ID == visualID
				|| IndividualEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = Dsl15926VisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != Dsl15926VisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = Dsl15926VisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = Dsl15926VisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TemplateInstanceEditPart.VISUAL_ID:
			return createTemplateInstance_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case ClassEditPart.VISUAL_ID:
			return createClass_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case TemplateEditPart.VISUAL_ID:
			return createTemplate_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case IndividualEditPart.VISUAL_ID:
			return createIndividual_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (Dsl15926VisualIDRegistry.getVisualID(elementTypeHint)) {
		case TemplateRoleInstanceEditPart.VISUAL_ID:
			return createTemplateRoleInstance_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case TemplateRoleEditPart.VISUAL_ID:
			return createTemplateRole_4002(getSemanticElement(semanticAdapter),
	 ...
	 * @generated
	 */
	public Node createTemplateInstance_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Dsl15926VisualIDRegistry
	...
	public Node createClass_2002(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Dsl15926VisualIDRegistry.getType(ClassEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createTemplate_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Dsl15926VisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createIndividual_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createTemplateRoleInstance_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(Dsl15926VisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createTemplateRole_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
