...
public class AnnotationImpl extends EObjectImpl implements Annotation {
	...
	protected EClass eStaticClass() {
		return Dsl15926Package.Literals.ANNOTATION;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dsl15926Package.ANNOTATION__TYPE, oldType, type));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dsl15926Package.ANNOTATION__VALUE, oldValue, value));
	}
