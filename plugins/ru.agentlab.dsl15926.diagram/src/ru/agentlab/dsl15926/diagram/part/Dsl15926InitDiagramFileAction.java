 ...
 * @generated
 */
public class Dsl15926InitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new Dsl15926NewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				RepositoryEditPart.MODEL_ID));
		Dsl15926DiagramEditorUtil.runWizard(getShell(), wizard,
