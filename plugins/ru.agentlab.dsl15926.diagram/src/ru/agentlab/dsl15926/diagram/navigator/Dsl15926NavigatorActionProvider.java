...
import ru.agentlab.dsl15926.diagram.part.Dsl15926DiagramEditor;
 ...
 * @generated
 */
public class Dsl15926NavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof Dsl15926NavigatorItem) {
					selectedElement = ((Dsl15926NavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (RepositoryEditPart.MODEL_ID
							.equals(Dsl15926VisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, Dsl15926DiagramEditor.ID);
