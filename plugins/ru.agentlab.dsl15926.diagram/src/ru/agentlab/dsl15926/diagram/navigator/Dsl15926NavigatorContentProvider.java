...
import ru.agentlab.dsl15926.diagram.part.Messages;

/**
 * @generated
 */
public class Dsl15926NavigatorContentProvider implements ICommonContentProvider {
	...
	public Dsl15926NavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<Dsl15926NavigatorItem> result = new ArrayList<Dsl15926NavigatorItem>();
		...
		if (parentElement instanceof Dsl15926NavigatorGroup) {
			Dsl15926NavigatorGroup group = (Dsl15926NavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof Dsl15926NavigatorItem) {
			Dsl15926NavigatorItem navigatorItem = (Dsl15926NavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case RepositoryEditPart.VISUAL_ID: {
			...
			Dsl15926NavigatorGroup links = new Dsl15926NavigatorGroup(
		...
		case TemplateRoleInstanceEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			Dsl15926NavigatorGroup target = new Dsl15926NavigatorGroup(
					Messages.NavigatorGroupName_TemplateRoleInstance_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Dsl15926NavigatorGroup source = new Dsl15926NavigatorGroup(
					Messages.NavigatorGroupName_TemplateRoleInstance_4001_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					Dsl15926VisualIDRegistry.getType(ClassEditPart.VISUAL_ID));
		...
		case TemplateInstanceEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			Dsl15926NavigatorGroup outgoinglinks = new Dsl15926NavigatorGroup(
					Messages.NavigatorGroupName_TemplateInstance_2001_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					Dsl15926VisualIDRegistry
	 ...
	 * @generated
	 */
	private Collection<Dsl15926NavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<Dsl15926NavigatorItem> result = new ArrayList<Dsl15926NavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new Dsl15926NavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof Dsl15926AbstractNavigatorItem) {
			Dsl15926AbstractNavigatorItem abstractNavigatorItem = (Dsl15926AbstractNavigatorItem) element;
