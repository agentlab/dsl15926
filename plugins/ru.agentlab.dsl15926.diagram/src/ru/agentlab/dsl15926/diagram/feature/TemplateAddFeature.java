...
public class TemplateAddFeature extends AbstractAddShapeFeature {
	...
	public TemplateAddFeature(IFeatureProvider fp) {
		super(fp);
	}
...
//			link(containerShape, addedClass);
		...
		
		{
			...
			containerShape2 = peCreateService.createContainerShape(
					targetDiagram, true);
//			containerShape.setLink( (PictogramLink) containerShape2);
