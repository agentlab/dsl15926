...
public class TemplateCreateFeature extends AbstractCreateFeature {

	private static final String TITLE = "Create class";

	private static final String USER_QUESTION = "Enter new class name";

	public TemplateCreateFeature(IFeatureProvider fp) {
		// set name and description of the creation feature
		super(fp, "Template", "Create 15926 Template");
	}
	...
	public Object[] create(ICreateContext context) {
		...
		Template clazz = Dsl15926FactoryImpl.eINSTANCE.createTemplate();
		// create EClass
