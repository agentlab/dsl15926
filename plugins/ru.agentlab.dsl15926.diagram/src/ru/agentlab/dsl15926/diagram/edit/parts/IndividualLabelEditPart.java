 ...
 * @generated
 */
public class IndividualLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public IndividualLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RepositoryEditPart.NodeLabelDragPolicy());
	}
			...
			parser = Dsl15926ParserProvider
					.getParser(
							...
							Dsl15926VisualIDRegistry
									.getType(ru.agentlab.dsl15926.diagram.edit.parts.IndividualLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
