...
import ru.agentlab.dsl15926.diagram.edit.policies.ClassItemSemanticEditPolicy;
...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClassLabelEditPart) {
			((ClassLabelEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(Dsl15926VisualIDRegistry
				.getType(ClassLabelEditPart.VISUAL_ID));
	}
	...
	public class ClassFigure extends RectangleFigure {
		...
		public ClassFigure() {
			...
			this.setMinimumSize(new Dimension(getMapMode().DPtoLP(123),
					getMapMode().DPtoLP(44)));
		...
		private void createContents() {
			...
			fFigureClassLabelFigure.setText("<...>");
