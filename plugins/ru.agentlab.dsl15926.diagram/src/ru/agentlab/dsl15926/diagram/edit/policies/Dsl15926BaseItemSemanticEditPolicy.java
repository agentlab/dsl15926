 ...
 * @generated
 */
public class Dsl15926BaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected Dsl15926BaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						Dsl15926VisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = Dsl15926ElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = Dsl15926DiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			Dsl15926DiagramEditorPlugin.getInstance().setLinkConstraints(
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateTemplateRole_4002(Template source,
				AbstractObject target) {
			return canExistTemplateRole_4002(null, source, target);
		}
		 ...
		 * @generated
		 */
		public boolean canExistTemplateRole_4002(TemplateRole linkInstance,
				Template source, AbstractObject target) {
			return true;
		}
	}
