...
import ru.agentlab.dsl15926.diagram.edit.policies.Dsl15926TextSelectionEditPolicy;
 ...
 * @generated
 */
public class TemplateRoleLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				Dsl15926VisualIDRegistry
						.getType(ru.agentlab.dsl15926.diagram.edit.parts.TemplateRoleLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public TemplateRoleLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new Dsl15926TextSelectionEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RepositoryEditPart.LinkLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return Dsl15926ElementTypes.getImage(parserElement.eClass());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					Dsl15926EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
