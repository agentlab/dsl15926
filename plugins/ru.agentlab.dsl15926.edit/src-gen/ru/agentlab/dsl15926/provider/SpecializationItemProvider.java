...
/**
 * This is the item provider adapter for a {@link ru.agentlab.dsl15926.Specialization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Specialization_superClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Specialization_superClass_feature", "_UI_Specialization_type"),
				 Dsl15926Package.Literals.SPECIALIZATION__SUPER_CLASS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSubClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Specialization_subClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Specialization_subClass_feature", "_UI_Specialization_type"),
				 Dsl15926Package.Literals.SPECIALIZATION__SUB_CLASS,
				 true,
				 false,
				 true,
				 null,
